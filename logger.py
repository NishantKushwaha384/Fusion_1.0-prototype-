...
def log_query(
    ...
    """Save a complete query record to the log file."""
...
def _get_session_id() -> str:
    """Return today's date as a session ID."""
...
def get_logs_by_date_range(start_date: str, end_date: Optional[str] = None) -> list:
    """
